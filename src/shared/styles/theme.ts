...
export const blogTextColor = "rgb(26, 32, 44)"

export const blogTextColorDark = "rgb(175, 187, 213)"

export const blogTextUnselectedColor = "rgb(113, 128, 150)"

export const blogTextSelectedColor = "rgb(49, 130, 206)"

export const blogFontFamily = "Inter, sans-serif"

export const blogTitleFontFamily = "Barlow, system-ui, Arial, sans-serif"

export const blogTagColor = "rgb(160, 174, 192)"

export const blogTagColorDark = "rgb(86, 95, 107)"

export const blogTagBackgroundColor = "rgb(237, 242, 247)"

export const blogTagBackgroundColorDark = "rgb(27, 30, 33)"
...
export const borderColorLight = "#f2f2f4"

export const borderColorDark = "#232324"

export const blogFontDarkColor = '#D9D9D9';
