...
import { dark, blogTitleFontFamily, flexRow, light } from '../../styles/theme'
...
const PreferencesPanelSelectorClient = ({ preferences }: { preferences: Preferences }) => {
  return <>
    <VSpace height={8} />
...
export default PreferencesPanelSelectorClient